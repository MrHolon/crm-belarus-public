...
Проект ведётся в локальном git-репозитории. Правила оформления коммитов — в `skills/12-git-workflow.md`.

## Дальнейшие шаги

1. Написать первую миграцию с таблицами и RLS-политиками из `ТЗ/03-сущности-и-база-данных.md` и `ТЗ/02-роли-и-права-доступа.md`.
2. Сгенерировать типы: `npm run gen:types`.
3. Добавить экран авторизации и защищённые роуты.
4. Дальше — по плану из `ТЗ/08-mvp-и-план-работ.md`.
